...
USERS = set()                           #list of connected users
...
#events to notify users of audio event (audio sent from a client) or usage state change event
...
# register / unresgiet user events to remove from loca user listing
    ...
    try:
        ...
        async for message in websocket:
            ...
            if data["action"] == "audio":
                ...
                if ( len(data["audio"]) == buffer_size ):                   # audio samples are being sent from the user
